...
class CustomFedAvg(FedAvg):
    ...
    def __init__(self, *args, save_every: int = 50, num_rounds: int = None, **kwargs):
        ...
        # Init W&B inside this experiment folder
        wandb.init(
            project="flower-simulation-tutorial",
            name=f"custom-strategy-{ts}",
    ...
    def aggregate_fit(
        ...
        # 2. Check if we should save this round
...
if DEVICE.type == "cuda":
    backend_config = {
        "client_resources": {
            ...
            "num_gpus": 0.25,  # or a fraction like 0.25 if you want multiple per GPU
        }
    }
